<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"./themes/default/member/cart\index.html";i:1569657151;s:39:"./themes/default/index/public/base.html";i:1569657151;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8" />
				...
				<?php if(is_array($goods) || $goods instanceof \think\Collection || $goods instanceof \think\Paginator): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?>
					...
					<tr class="goods<?php echo $d['cart_id']; ?>">
						<td style="width:100px;padding:20px;">
							...
							<a style="position:relative;display:block;" href="<?php echo url('/goods/'.$d['goods_id']); ?>"><img src="/<?php echo $d['image']; ?>" />
								<?php if($d['shipping'] == 0): ?>
						...
						<td>
							<a href="<?php echo url('/remove/'.$d['cart_id']); ?>">
								<img class="btooltip" data-toggle="tooltip" data-placement="bottom" data-original-title="删除" src="/public/static/view_res/home/images/remove.png" alt="删除" title="删除" />
							</a>
						</td>
					</tr>
