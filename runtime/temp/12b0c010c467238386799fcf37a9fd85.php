<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./themes/default/member/order_member\index.html";i:1569657151;s:81:"D:\phpstudy2018\PHPTutorial\WWW\oscshop2\themes\default\member\public\member.html";i:1569657151;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<table class="table table-striped table-bordered table-hover search-form">
	<thead>
		...
		<th>
			<a class="btn btn-primary" href="javascript:;" id="search" url="<?php echo url('OrderMember/index'); ?>">查询</a>
		</th>
	</thead>
</table>	
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>						
							...
							<td id="upay<?php echo $v['order_id']; ?>"><?php echo $v['name']; if($v['order_status_id'] == config('default_order_status_id')): ?>
								 / <a order_id="<?php echo $v['order_id']; ?>" id="pay<?php echo $v['order_id']; ?>" class="re_pay">去支付</a> / <a class="delete" href="<?php echo url('OrderMember/cancel',array('id'=>$v['order_id'])); ?>">取消订单</a>
								<?php endif; ?>
								</td>
							<td>
							...
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo url("OrderMember/show_order",array("id"=>$v["order_id"])); ?>'>
...
$(function(){
   $("#search").click(function () {
    ...
    $('.re_pay').click(function(){
		...
		var url="<?php echo url('Payment/Payment/choice_payment_type'); ?>"+"/order_id/"+order_id;
