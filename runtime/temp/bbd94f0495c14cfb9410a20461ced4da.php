<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./themes/default/mobile/agent_backend\share.html";i:1569657151;s:37:"./oscshop/admin/view/public/base.html";i:1569657151;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
			...
			<table id="table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>		
							...
							<td><a target="_blank" href="<?php echo $v['url']; ?>"><?php echo $v['url']; ?></a></td>							
						...
						<tr>
							<td colspan="20" class="page">总计 <?php echo ($list->total() ?: "0"); ?> 个分享</td>
						</tr>
				</tbody>
